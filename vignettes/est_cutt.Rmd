...
ds = dcutt(xs,12500,K=14250,sd=mean(deerSds),df=3)
plot(xs,ds,type="l")
```
...
It is hard to compare histograms to check assumptions, unless you have a big sample size. I would suggest constructing a qqplot against the best-fitting CUTT distribution as follows:
