...
#' @param method Method used to construct point estimate and confidence intervals. Default is to use bootstrap inversion (\code{\link{bootlrt_cutt}}) if
...
#' 
#' @return This function returns an object of class "reginv" or "est_cutt" with the following components:
#'
...
{  
  ...
  if(method!="reginv" & method!="bootlrt")
  {
    if(method!="mle") warning("'method' not recognised, will use 'mle'")
