...
#' @param df Numeric; degrees of freedom for the t-distribution used to model measurement error. Must be at least 2. Default (Inf) uses a Gaussian distribution.
